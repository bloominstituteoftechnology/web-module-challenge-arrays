...
function removeLastFlavor(newArray){
    newArray.pop();
   return newArray;
}
...
function getFlavorByIndex(newArray){
    /*your code here*/
}
...
function removeFlavorByName(newArray, flavorName) {
    for (var i = 1; i < newArray.length; i++) {
      if (newArray[i] === flavorName) {
        newArray.splice(i, 1);
        return newArray;
      }
    }
...
function filterByWord(newArray,) {
    if(Array.includes('chocolate')){
        const newArray = ["Chocolate", "Chocolate Almond", "Chocolate Chip", "Chocolate Fudge", "Chocolate Mint", "Chocolate Ribbon"];
