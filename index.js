...
function getFlavorByIndex(neworiginalFlavors, num){
    return neworiginalFlavors[num];
}
...
function removeFlavorByName(neworiginalFlavors, flavor){
    return neworiginalFlavors.filter(a => a !== flavor);
}
...
function filterByWord(originalFlavors, stg){
    return originalFlavors.filter(a => a.includes("Chocolate"));
}
