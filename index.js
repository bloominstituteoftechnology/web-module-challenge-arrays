...
function removeFlavorByName(originalFlavors, a){
    const index = originalFlavors.indexOf(a)
...
function filterByWord(originalFlavors, a){
    const returnOriginalFlavors = [];
    for(let i = 0; i < originalFlavors.length; i++) {
        if (originalFlavors[i].includes(a)) {
            returnOriginalFlavors.push(originalFlavors[i]);
        }
    }
    return returnOriginalFlavors;
}
