...
function addFlavor(any, originalFlavors){

    originalFlavors.unshift(any);
...
function getFlavorByIndex(any, any){
    console.log(originalFlavors[any]);
  }
...
function removeFlavorByName(any, any){
...
function filterByWord(array, any){
    let newArray 
    =array.includes(any);
