...
removeLastFlavor.pop("Vanilla Burnt Almond"); {
...
function removeFlavorByName(originalFlavors, removalFlavor){
...
function filterByWord(originalFlavors, filterFlavor){
  const foundFlavors = [];
  for (i-0, i< originalFlavors.length; i++){
...
filterByWord(originalFlavors, "Pinneapple Sherbert")
