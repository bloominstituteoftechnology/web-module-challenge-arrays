...
function is31Flavors(originalFlavors) {
  if (originalFlavors === 31) console.log('True');
  else console.log(False);
}

/* Task 2: Corporate has come to you with an idea for a new flavor: Rainbow Sherbert! They think this 
will be a game changer. You need to modify the array to include this flavor. 
...
function copyFlavors() {
  let originalFlavors2 = originalFlavors.slice();
  console.log(originalFlavors2.length);
}
...
/* Task 7: July 7th is "World Chocolate Day" and Baskin Robins wants to create promotional materials highlighting
 all of their chocolate flavors. Write a function that checks every item in the array for a given string and returns
  ...
  pass a string as a parameter, and invoke with the argument "chocolate". This way you could also filter for
