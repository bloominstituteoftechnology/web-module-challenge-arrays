...
function copy(originalFlavors){
  originalFlavors = originalFlavors.slice();
...
function addFlavor(originalFlavors, addFlavor){
...
console.log(removeFlavorByName(originalFlavors.pop));
...
function getFlavorByIndex(originalFlavors){
  originalFlavors.getFlavorByIndex(originalFlavors, 6)
}
console.log(getFlavorByIndex(originalFlavors, getFlavorByIndex[6]))
...
function removeFlavorByName(originalFlavors){
  removeFlavorByName.splice(originalFlavors, "Rocky Road")
    return originalFlavors
}
...
function filterByWord(originalFlavors){
  filterByWord.includes(originalFlavors, "Chocolate")
    return ["Chocolate Almond", "Chocolate Chip", "Chocolate Fudge", "Chocolate Mint", "Chocolate Ribbon"]
}
console.log(filterByWord(originalFlavors, "Chocolate Almond", "Chocolate Chip", "Chocolate Fudge", "Chocolate Mint", "Chocolate Ribbon"));
