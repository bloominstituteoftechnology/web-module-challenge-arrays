...
function is31Flavors(arrayProvided){
...
function removeFlavorByName(arrayProvided, flavo){
for ( i = 0; i < arrayProvided.length; i++) {
    if (flavo === arrayProvided[i]) {
