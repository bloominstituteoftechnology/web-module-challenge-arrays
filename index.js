...
// TEST CODE:
var output = is31Flavors(originalFlavors);
console.log(output); // should return true
...
function addFlavor(array, newFlavor){
  ...
  // TEST CODE:
  var output = addFlavor(originalFlavors, "mac nut latte")
  console.log(output); // should return array + added flavor
