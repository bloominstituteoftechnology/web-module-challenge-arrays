...
addFlavor(originalFlavors, "Banana Split");
...
function removeFlavorByName(array, icecream){
...
function filterByWord(array, string){
  const newFilterByWord = [];
  for(let i = 0; i < array.length; i++){
    if(array[i].includes(string)){
      newFilterByWord.push(array[i])
    }
  }
  return newFilterByWord;
}
