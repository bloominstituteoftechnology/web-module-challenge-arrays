...
function getFlavorByIndex(originalFlavors, target) {
	return originalFlavors[target];
}
...
function removeFlavorByName(originalFlavors, retiredFlavor) {
	originalFlavors.splice(originalFlavors.indexOf(retiredFlavor), 1);
	return originalFlavors;
}
