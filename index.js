...
function removeLastFlavor() {
    ...
    var removeLastFlavor = [...addFlavor];
...
function removeFlavorByName(arr, flavor){
    ...
    console.log('Remaining flavors', arr);
    /*code here*/
...
rotatingMenu = [...originalFlavors];
console.log(rotatingMenu);
...
function getRandomFlavors(flavorList1, flavorList2, flavorList3, flavorList4) {
    let randomFlavors = [];
    let numallFlavors = 31*4;
    let newflav;
    let pickedIndex;
    let allLists = [...flavorList1, ...flavorList2, ...flavorList3, ...flavorList4];
    /*code here*/
    for (let i = 0; i < 31; i++) {
        pickedIndex = (Math.floor(Math.random() * numallFlavors));
        newflav = allLists[pickedIndex];
        console.log(newflav);
        randomFlavors.push(newflav);
        allLists.splice(pickedIndex, 1);
        numallFlavors--;
    };
