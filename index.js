...
function is31Flavors(flavorList){
    ...
    if (flavorList.length === 31) {
        return true;
    }
    else if (flavorList.length !== 31) {
        return false;
    }
...
addFlavor("Rainbow Shebert", originalFlavors); //test                                                                                                                                                                                                                                                                                                                                                                                                                                                  
...
function getFlavorByIndex(flavorList){
...
function copy(newList, mainList){
...
const newList = [];
console.log(copy(newList, originalFlavors)); //test
...
function filterByWord(listSearch, flavor){

    const filter = [];
    for(let i = 0 i < listSearch.length; i++){
        if(listSearch[i].includes(flavor)){
            filter.push(listSearch[i]);
        }
    }
    return filter;
}
