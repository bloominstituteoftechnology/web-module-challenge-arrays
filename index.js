...
function addFlavor(newFlavorsSetup){
   newFlavorsSetup.unshift("Rainbow Sherbert");
   return newFlavorsSetup;
}
...
function removeLastFlavor(newFlavorsSetup){
   newFlavorsSetup.pop();
   return newFlavorsSetup;
...
function getFlavorByIndex(newFlavorsSearch, []){
    newFlavorsSearch.slice();
    return newFlavorsSearch;
}
