...
function is31Flavors(inputArr){
    if(inputArr.length == 31){
        return true;
    }
    else return false;
}
...
function addFlavor(inputArr, inputFlavor){
   inputArr.unshift(inputFlavor);
   return inputArr;
}
...
function removeLastFlavor(inputArr){
   inputArr.pop();
   return inputArr;
}
...
function getFlavorByIndex(inputArr, indexNum){
    return inputArr[indexNum];
}
...
function removeFlavorByName(inputArr, inputFlavor){
    var indexNum;
    if(inputArr.includes(inputFlavor)){
        indexNum = inputArr.findIndex(inputFlavor);
...
function filterByWord(inputArr, inputFilter){
    var returnArr = [];
    for(var i = 0; i < inputArr.length; i++){
        if(inputArr[i].includes(inputFilter)){
