...
function removeFlavorByName() {
    Flavors.splice(6, 1, "Chocolate Almond");
    console.log(Flavors);
}
...
function copy() {
    var FlavorsCopy = ["Banana Nut Fudge",
        "Black Walnut",
        "Burgundy Cherry",
        "Butterscotch Ribbon",
        "Cherry Macaron",
    ...
    console.log(Flavors, FlavorsCopy);
...
function filterByWord() {
    ...
    "Vanilla",
    "Vanilla Burnt Almond"
    var Flavors = Flavors.includes("Chocolate")
    console.log(Flavors.includes);
