...
function copy(originalFlavors) {
   let is31Flavors = [...originalFlavors];
   return is31Flavors;
}
...
//    return originalFlavors.unshift(flavor);
    return [flavor].concat(originalFlavors);
}
...
function removeLastFlavor(originalFlavors){
   return originalFlavors.splice(0, originalFlavors.length - 1);
}
...
function removeFlavorByName(originalFlavors, flavor){
    /*your code here*/
    return originalFlavors.filter(item => item != flavor)
}
