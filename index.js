...
function addFlavor(array, newFlavors){
   /*your code here*/
   array.unshift(newFlavors)
   console.log(array);
}
...
function getFlavorByIndex(arrayFour, indexNumber){
    /*your code here*/
    let sliceArray = arrayFour.slice(indexNumber-1, indexNumber)
    console.log(sliceArray.toString());
}
