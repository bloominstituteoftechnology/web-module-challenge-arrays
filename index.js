...
function addFlavor(newFlavor,anArray){
   return anArray.unshift(newFlavor);
}
...
function removeFlavorByName(anArray,flavor){
    var index = anArray.indexOf(flavor);
    if(index!==-1){
    return anArray.splice(index,1);
    }
}
