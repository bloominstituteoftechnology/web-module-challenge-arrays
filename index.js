...
function addFlavor(originalFlavors, newFlav){
...
*/
let res = [];
function filterByWord(originalFlavors, str){
    
    for(let i = 0; i < originalFlavors.length; i++) {
        if(originalFlavors[i].includes(str)){
            
            res.push(originalFlavors[i]);
        }
    }
    return res;
}
...
function getRandomFlavors(originalFlavors){
    /*code here*/
}
