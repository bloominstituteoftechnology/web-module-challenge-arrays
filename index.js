...
function is31Flavors(check) {
  return check.length == 31;
}
...
function removeFlavorByName(list, item) {
...
function filterByWord(list) {
  for (i = 0; i < list.length; i++) {
    return list[i].includes("Chocolate") == true;
  }
}
