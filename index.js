...
function copy(originalFlavors){
    let neworiginalFlavors = [...originalFlavors]
}    
...
function is31Flavors(neworiginalFlavors){
   neworiginalFlavors.length()
   if (neworiginalFlavors.valueOf(31) === true) {
    return true;
  } else {
    return  false; }
}
...
function addFlavor(neworiginalFlavors){
   neworiginalFlavors.unshift("Rainbow Sherbert");
}
...
function removeLastFlavor(neworiginalFlavors){
...
function getFlavorByIndex(neworiginalFlavors){
    getFlavorByIndex (neworiginalFlavors,2);
    return "Black Walnut"
}
...
function removeFlavorByName(neworiginalFlavors,){
    neworiginalFlavors.splice(-4,1, "","Rocky Road" );
    return neworiginalFlavors
}
...
function filterByWord(neworiginalFlavors,){
    console.log(neworiginalFlavors.include(name => name.includes('Chocolate')));
   return 
}
