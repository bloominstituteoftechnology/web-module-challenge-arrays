...
function copy(originalFlavors){
    let flavorCopy = Array.from(originalFlavors)
    return flavorCopy;
...
function is31Flavors(arraylen){
    
        if (arraylen.length === 31){
          return true;
        } else {
          return false;
        }
...
function addFlavor(newFlava, RainbowS){
    newFlava.unshift(RainbowS)
   return newFlava;
}
