...
function getFlavorByIndex(originalFlavors){
    return originalFlavors.indexOf("Black Walnut", 2)
}
...
function removeFlavorByName(removedByName, nameOf) {
    for (let i = 0; i < removedByName.length; i++) {
      if (removedByName[i] == nameOf) {
      let removed =  removedByName.splice( i, 1);
      return removed
      }
    }
  }
