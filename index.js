...
function addFlavor(receiveingArray, flavor){
    receiveingArray.unshift(flavor);
    return receiveingArray;
 }
...
function removeLastFlavor(receiveingArray, flavor){
    receiveingArray.pop(flavor);
    return receiveingArray;
 }
