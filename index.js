...
const getFlavorByIndex = originalFlavors.indexOf("Lemon Crisp");
...
const i = originalFlavors.indexOf("Vanilla");

originalFlavors.splice(i, 29);
...
const copy31Flavors = [...originalFlavors]

console.log(copy31Flavors);
